            ...
            <form action="{{ route('coupons.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="code" class="form-control form-control-lg" 
                           placeholder="Enter unique coupon code" value="{{ old('code') }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="discount_value" class="form-control form-control-lg" 
                           placeholder="Enter discount value" value="{{ old('discount_value') }}">
                </div>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success btn-lg px-5 fw-bold">Create Coupon</button>
                </div>
            </form>
